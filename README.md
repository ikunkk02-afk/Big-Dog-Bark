...
- **发射方式:声波冲击(大狗本体不离开玩家)**:
  ...
  - 波前以 1 格/tick 匀速推进约 45 格(2.25 秒),沿途**以扇形方式摧毁方块**:以发射点为顶点、沿飞行方向水平扩散 30°(俯视为扇形,垂直约 5 格高),整条声波路径经过的扇形区域全部破坏(爆炸抗性低于 1000 的方块,掉落物不保留;流体、基岩、黑曜石等高抗性方块不受影响)——可以成片打穿墙壁与建筑物;
  - 沿途对路径上的**生物**造成冲撞伤害(无视护甲的音波伤害,蓄能越高伤害越高:6 → 16)与击退,每个生物只结算一次,不伤害发射者本人;
